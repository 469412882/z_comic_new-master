...
public class ComicChapterActivity extends BaseActivity<ComicChapterPresenter> implements IChapterView<PreloadChapters>{
    ...
    protected void initPresenter(Intent intent) {
        ...
        chapterId = intent.getIntExtra(Constants.COMIC_CHAPERS,0);
    }
...
//        setNavigation();
        mLoadingTitle.setText(mComic.getTitle());
        ...
        mWebview.loadUrl("http://ac.qq.com/ComicView/index/id/"+mComic.getId()+"/cid/"+(chapterId + 1));
